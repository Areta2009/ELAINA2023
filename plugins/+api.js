...
case 'infobot':
if (!iselaina) return sendButMessage(from, lang.noregis(pushname), `Klik Button Untuk Verify`, [{buttonId: '.daftar',buttonText: {displayText: `Daftar`,},type: 1,}], {quoted: fgif});
			reply('Update bot selanjutnya silahkan cek YouTube Roy Senpai')
break
case 'owner':{
if (!iselaina) return sendButMessage(from, lang.noregis(pushname), `Klik Button Untuk Verify`, [{buttonId: '.daftar',buttonText: {displayText: `Daftar`,},type: 1,}], {quoted: fgif});
...
case 'ppcp': 
       ...
       cewe = await getBuffer(anu.result.cewe_image)
		    pll = `Ini Untuk  **`
   sendButImage(from, pll, `Itsuka Indra  2022`, cewe, [                      
          {
...
if (q == computer) {
reply(`*Subscribe Roy Senpai*\n\nPertandingan Seri!`)
} else if (q == 'batu') {
if (computer == 'gunting') {
reply(`*Subscribe Yt Roy Senpai*\n\n You: Batu\n Computer: Gunting\n\nCongrats You win!`)
} else {
reply(`*Subscribe Yt Roy Senpai*\n\n You: Batu\n Computer: Kertas\n\nYou lose:(`)
}
} else if (q == 'gunting') {
