...
let handler = async (m, { conn, text, usedPrefix, command, isOwner, isPrems }) => {
    ...
    if (!text) throw `Silahkan masukan link group target!\n\nContoh: ${usedPrefix + command} https://chat.whatsapp.com/DuwmbXQJQyw73HGAHMNEuZ`;
 ...
 * Jangan Di Hapus!!
 * 
 * Buatan @RoyOfc (Fokus ID)
 * Github: https://github.com/Areta2023
 * 
 * Ingin bikin fitur tapi tidak bisa coding?
 * hubungi: https://wa.me/62889803928
 * 
 */