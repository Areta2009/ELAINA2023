 ...
 if (teks == 'edukasi') tags = {
  ...
  try {
      ...
      const sections = [
   {
	...
	rows: [
	    {title: `📛)ഒ Info Bot`, rowId: ".botinfo", description: "✧ Info nya Elaina ><"},
	...
	{title: `⚡)ഒ Speed`, rowId: ".speed", description: "✧ Kecepatan Respon 赤 Elaina..."},
	]
    },{
...
 
    ...
    ◉  𝙎𝙩𝙖𝙩𝙪𝙨 : *${m.sender.split`@`[0] == nomorown ? 'DEWA' : (usrs.premiumTime >= 1 ? 'Premium User' : 'Gratisan')}* 
...
const listMessage = {
  text: tek,
  footer: '© Itsuka Indra | ALL RESERVED',
            ...
            templateButtons: [
                {
                    urlButton: {
                        displayText: `${namebot}`,
                        url: 'https://chat.whatsapp.com/DuwmbXQJQyw73HGAHMNEuZ'
                    }
                },
                {
                    urlButton: {
