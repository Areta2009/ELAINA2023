...
`
     const message = {
            document: { url: thumb },
            jpegThumbnail: await (await fetch(thumb)).buffer(), fileName: 'hmm', mimetype: dpdf, fileLength: fsizedoc, pageCount: fpagedoc,
            caption: anu,
            footer: wm,
            templateButtons: [
                {
                ...
                },
                {
                    urlButton: {
                        ...
                        url: 'https://youtu.be/OnWiC-SYk4M'
                    }
                },
                {
                    quickReplyButton: {
